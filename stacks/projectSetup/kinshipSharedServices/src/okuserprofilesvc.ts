...
const projectName = "ok-user-profile-svc"

export const okuserprofilesvcProject = projectSetup({
  projectName,
  cicdUserPermissions: [
    ...readWriteEcr(`kinship-shared-services`),
    ...readWritePulumiStateAndSsm(pulumiStateBucketName, projectName),
    ...adminRds("user-profile"),
    ...adminS3Bucket("kinshipid"),
    ...snsMonitoring(projectName),
    ...cloudwatchMonitoring("user-profile"),
    readAllPulumiSsmOutputs,
    ekslistAndDescribe,
  ],
})
