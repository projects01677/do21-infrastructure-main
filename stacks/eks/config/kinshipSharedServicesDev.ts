...
export const kinshipSharedServicesDevConfig = (): Configuration => {
  const vpcStackReference = new StackReference("vpc-kinship-shared-services-dev")
  ...
  return {
    ...
    privateSubnetIds,
    envName: "dev",
    eksClusterName: "kinship-shared-services-dev",
    ingress: {
      public: {
    ...
    k8sClusterAdminArns: {
      roles: k8sRoleArnsFor({ account: "kinshipSharedServices", env: "dev", clusterPermission: "clusterAdmin" }),
      users: [],
    },
    k8sViewOnlyArns: {
      roles: k8sRoleArnsFor({ account: "kinshipSharedServices", env: "dev", clusterPermission: "viewOnly" }),
      users: [],
    },
    k8sNamespaces: [
      {
      ...
      },
      {
        name: "goodfriend-api",
        adminArns: {
          users: ["arn:aws:iam::575036886166:user/service/goodfriend-api-cicd"],
          roles: iamRolesPartOfProject("goodfriend-api"),
        },
      },
      {
        name: "goodfriend-website",
        adminArns: {
          users: ["arn:aws:iam::575036886166:user/service/goodfriend-website-cicd"],
          roles: iamRolesPartOfProject("goodfriend-website"),
        },
      },
    ],
