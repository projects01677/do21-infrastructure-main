...
export const kinshipSharedServicesProductionConfig = (): Configuration => {
  const vpcStackReference = new StackReference("vpc-kinship-shared-services-production")
  ...
  return {
    ...
    privateSubnetIds,
    envName: "production",
    eksClusterName: "kinship-shared-services-production",
    ingress: {
      public: {
    ...
    k8sClusterAdminArns: {
      roles: k8sRoleArnsFor({ account: "kinshipSharedServices", env: "production", clusterPermission: "clusterAdmin" }),
      users: [],
    },
    k8sViewOnlyArns: {
      roles: k8sRoleArnsFor({ account: "kinshipSharedServices", env: "production", clusterPermission: "viewOnly" }),
      users: [],
    },
    k8sNamespaces: [
      {
